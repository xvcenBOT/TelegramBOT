...
NOTICE = "*‼️ Важная информация!*\n\n"
UNIFIED_NOTICE_BODY = (
    "*Проверка получения подарков осуществляется автоматически только при отправке на аккаунт @GiftGuarantHelp.*\n\n"
    "*Если NFT подарок, username, +888, чат или канал отправлены напрямую покупателю:*\n"
    "• Они будут утеряны 😔\n"
    "• Сделка будет считаться несостоявшейся, что приведет к потери вашего товара и денежных средств 💸\n\n"
...
NOTICES = {
    'gift': NOTICE + UNIFIED_NOTICE_BODY,
    'channel': NOTICE + UNIFIED_NOTICE_BODY,
    'stars': NOTICE + UNIFIED_NOTICE_BODY,
    'nft': NOTICE + UNIFIED_NOTICE_BODY,
}
